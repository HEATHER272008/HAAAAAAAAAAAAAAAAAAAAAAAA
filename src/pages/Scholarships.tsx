  ...
  const scholarships = [
    {
      ...
      coverage: "₱9,000.00",
      requirements: ["Applicant must be an incoming Junior High School student."],
    },
    {
      icon: Users,
      ...
      requirements: ["Applicant must be an incoming Senior High School student."],
    },
    {
      icon: Heart,
      ...
      requirements: ["Must be enrolled as a regular student with a full academic load for the entire school year."],
    },
  ];
